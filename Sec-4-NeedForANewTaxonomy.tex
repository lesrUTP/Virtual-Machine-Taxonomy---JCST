	...
	%El enfoque taxonómico \textit{Tipo de máquina virtual} es el más popular, tal como lo ratifican los trabajos de \textit{Smith}, \textit{SCOPE Allinace}, \textit{Pessolani} y \textit{Pék}. Por otro lado, \textit{Kampert} y \textit{Kusnetzky} toman un camino diferente, cuyo objetivo es considerar de forma general, la mayor cantidad de dominios tecnológicos en los que sea posible realizar procesos de virtualización, de ahí el nombre del enfoque taxonómico \textit{dominios de virtualización}. Finalmente, \textit{Chiueh} considera el enfoque taxonómico \textit{nivel de abstracción} como un elemento fundamental para la categorización de tecnologías de virtualización. Al presentarse diversidad en estos enfoques, es evidente que la comunidad interesada en estas temáticas puede sentirse confundida al leer un autor u otro, y es por ello que existe también la necesidad de una taxonomía que brinde una vista unificada, organizada y actualizada de esta temática.
	...
	%Por todo lo anterior, y una vez realizado el análisis de las taxonomías, se ha identificado la necesidad de proponer una nueva taxonomía, fusionando y extendiendo algunos elementos y enfoques. Esta nueva taxonomía debe ser un instrumento para brindar apoyo en procesos pedagógicos de enseñanza y aprendizaje en la comunidad académica con intereses en las tecnologías de virtualización. Por otra parte, la taxonomía también debe facilitar la visualización del ecosistema tecnológico que rodea esta temática y en consecuencia, ayudar también a la industria en los procesos de toma de decisiones para la  selección de este tipo de tecnologías.
